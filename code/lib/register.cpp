...
std::string Register::toString(){
  switch (this->mode){
    case RegisterMode::uint8:
      return std::to_string(this->value.uint8);
    case RegisterMode::int8:
      return std::to_string(this->value.int8);
    case RegisterMode::uint16:
      return std::to_string(this->value.uint16);
    case RegisterMode::int16:
      return std::to_string(this->value.int16);
    case RegisterMode::uint32:
      return std::to_string(this->value.uint32);
    case RegisterMode::int32:
      return std::to_string(this->value.int32);
    case RegisterMode::uint64:
      return std::to_string(this->value.uint64);
    case RegisterMode::int64:
      return std::to_string(this->value.int64);
    case RegisterMode::float32:
      return std::to_string(this->value.float32);
    case RegisterMode::float64:
      return std::to_string(this->value.float64);
  }
